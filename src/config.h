...
constexpr const char*  CONFIG_FILE    = "esp_config.dat";
...
struct Config {
    ...
    // not persisted — save/load stops before this field
    bool showMenu = false;
...
constexpr const char* BOX_STYLES[]  = { "Full", "Corner", "3D" };
constexpr int         BOX_STYLE_COUNT = 3;
